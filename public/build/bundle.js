...
var app = (function () {
    ...
    const totalCitiesCount = readable(15);
    let cities = writable([]);

    const populationCount = readable(1000);
    let populations = writable([
      {
    ...
    const allCities = get_store_value(cities);
    ...
    function generateBitMask() {
      ...
      const hex = randomHex(Math.ceil(get_store_value(totalCitiesCount) / 4));
      return parseInt(hex, 16).toString(2).padStart(8, '0').split('').map((value) => parseInt(value))
    }

    function getCanonicalOrder() {
      return [...Array(get_store_value(totalCitiesCount)).keys()];
    }
    ...
    const ordinalOnePointCrossover = (orderA, orderB) => {
      ...
      const slicePoint = Math.ceil(get_store_value(totalCitiesCount) / 2) - 1;
    ...
    const createIndiviual = () => {
      const cityOrder = Object.keys(get_store_value(cities)).map((v) => parseInt(v));
      return shuffle(cityOrder)
    };

    const createPopulations = () => {
      const individuals = [...Array(get_store_value(populationCount)).keys()].map(() => createIndiviual());
      populations.set(
        get_store_value(populations).map((population) => { 
          return {
            ...population,
    ...
    const evolvePopulations = () => {
      populations.set(
        get_store_value(populations).map(
    ...
    function mutate(order, mutationRate) {
      const count = get_store_value(totalCitiesCount);
    ...
    */
    ...
    /* src/PerformanceChart.svelte generated by Svelte v3.23.0 */
    const file = "src/PerformanceChart.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(canvas_1, "max-width", "30vw");
    			add_location(canvas_1, file, 52, 0, 992);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		chart = new Chart(canvas, { type: "line", data: getGraphData() });
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<PerformanceChart> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("PerformanceChart", $$slots, []);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("currentPopulations" in $$props) currentPopulations = $$props.currentPopulations;
    ...
    class PerformanceChart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/CityMap.svelte generated by Svelte v3.23.0 */
    const file$1 = "src/CityMap.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$1, 41, 0, 803);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, cities, $$value => $$invalidate(6, $cities = $$value));
    	let { key } = $$props;
    	let { width } = $$props;
    	let { height } = $$props;
    	let canvas, ctx;
    	...
    	const writable_props = ["key", "width", "height"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<CityMap> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("CityMap", $$slots, []);
    ...
    class CityMap extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { key: 3, width: 0, height: 1 });
    		...
    		if (/*key*/ ctx[3] === undefined && !("key" in props)) {
    			console.warn("<CityMap> was created without expected prop 'key'");
    		}

    		if (/*width*/ ctx[0] === undefined && !("width" in props)) {
    			console.warn("<CityMap> was created without expected prop 'width'");
    		}

    		if (/*height*/ ctx[1] === undefined && !("height" in props)) {
    			console.warn("<CityMap> was created without expected prop 'height'");
    		}
    	}

    	get key() {
    		throw new Error("<CityMap>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set key(value) {
    		throw new Error("<CityMap>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*label*/ ctx[0]);
    			attr_dev(button, "class", "font-bold py-2 px-4 rounded");
    			add_location(button, file$2, 13, 0, 252);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [label, dispatch, click_handler];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const button1 = new Button({ props: { label: "Stop" }, $$inline: true });
    	button1.$on("click", /*click_handler_1*/ ctx[6]);
    	const performancechart = new PerformanceChart({ $$inline: true });

    	const citymap0 = new CityMap({
    			props: {
    				key: "bestEver",
    				width: /*width*/ ctx[1],
    				height: /*height*/ ctx[2]
    	...
    	const block = {
    		c: function create() {
    			aside = element("aside");
    			h1 = element("h1");
    			h1.textContent = "Genetic Algorithms";
    			t1 = space();
    			nav = element("nav");
    			...
    			t4 = text(/*width*/ ctx[1]);
    			t5 = text(":");
    			t6 = text(/*height*/ ctx[2]);
    			t7 = space();
    			hr = element("hr");
    			t8 = space();
    			create_component(performancechart.$$.fragment);
    			t9 = space();
    			main = element("main");
    			create_component(citymap0.$$.fragment);
    			t10 = space();
    			create_component(citymap1.$$.fragment);
    			attr_dev(h1, "class", "p-4 text-lg");
    			add_location(h1, file$3, 40, 1, 936);
    			add_location(nav, file$3, 41, 1, 985);
    			add_location(hr, file$3, 57, 1, 1269);
    			attr_dev(aside, "class", "what svelte-2ezc6s");
    			add_location(aside, file$3, 39, 0, 914);
    			add_location(main, file$3, 62, 0, 1307);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(aside, hr);
    			append_dev(aside, t8);
    			mount_component(performancechart, aside, null);
    			insert_dev(target, t9, anchor);
    			insert_dev(target, main, anchor);
    			mount_component(citymap0, main, null);
    			append_dev(main, t10);
    			mount_component(citymap1, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			...
    			transition_in(performancechart.$$.fragment, local);
    			transition_in(citymap0.$$.fragment, local);
    			transition_in(citymap1.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(button0.$$.fragment, local);
    			transition_out(button1.$$.fragment, local);
    			transition_out(performancechart.$$.fragment, local);
    			transition_out(citymap0.$$.fragment, local);
    			transition_out(citymap1.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(performancechart);
    			if (detaching) detach_dev(t9);
    			if (detaching) detach_dev(main);
    			destroy_component(citymap0);
    			destroy_component(citymap1);
    		}
    	};
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $cities;
    	let $totalCitiesCount;
    	validate_store(cities, "cities");
    	component_subscribe($$self, cities, $$value => $$invalidate(3, $cities = $$value));
    	validate_store(totalCitiesCount, "totalCitiesCount");
    	component_subscribe($$self, totalCitiesCount, $$value => $$invalidate(4, $totalCitiesCount = $$value));
    	let speed = 2;
    	let width = 500;
    	let height = 300;

    	onMount(() => {
    		set_store_value(cities, $cities = generateCities($totalCitiesCount, { width, height }));
    		createPopulations();
    	});
    	...
    	const click_handler = () => live(() => evolvePopulations(), speed * 100);
    	...
    	$$self.$capture_state = () => ({
    		...
    		totalCitiesCount,
    		populations,
    		initializePopulations: createPopulations,
    		live,
    		evolvePopulations,
    		stop,
    		generateCities,
